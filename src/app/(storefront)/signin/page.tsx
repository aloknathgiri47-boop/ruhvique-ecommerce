    ...
    <div className="grid lg:grid-cols-2 min-h-[calc(100vh-4rem)]">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-primary text-primary-foreground p-12">
        <Link href="/" className="group inline-flex items-center gap-3">
          ...
          <span className="text-3xl font-black tracking-[0.2em] group-hover:tracking-[0.25em] transition-all">RUHVIQUE</span>
        </Link>
        <div>
          <h1 className="text-4xl font-black tracking-tight leading-tight">
            Welcome back to the wardrobe that gets you.
          </h1>
          <p className="mt-4 text-primary-foreground/70 max-w-md">
            Sign in to track your orders, save your wishlist, and check out faster.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-6 p-3 rounded-md bg-muted/50 text-xs text-muted-foreground">
            ...
            <p className="mt-1">Email: <span className="font-mono">customer@demo.com</span></p>
